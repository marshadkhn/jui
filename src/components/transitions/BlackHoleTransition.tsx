    ...
    const initHelicalVortexField = useCallback((w: number, h: number) => {
      ...
      if (Object.keys(textureCache.current).length === 0) {
        ...
        allStrings.forEach((str) => {
          const isBig = str.length > 5 || ['7', '9', '3', '8', '6', 'क', 'अ', 'श', 'म', 'क्ष', 'ज्ञ', 'र', 'ल', 'व', 'ह', 'त', 'प'].includes(str);
          const font = isBig
      ...
      const rayCodeKeys = [
        ...
        '0325918671539', 'क्ष', '6198752130467', 'ज्ञ', '8745120032166', '1256897420136', 'त',
      ...
      const microKeys = [
        ...
        '00', 'स', 'ह', '०', 'क्ष', '१', 'त्र', '२', 'ज्ञ', '३', 'श्र', '४', 'आ', '५', 'इ',
